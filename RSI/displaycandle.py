...
def divSignal(df, x, nbackcandles):
    # global maxim, minim, xxmin, xxmax, maximRSI, minimRSI, xxminRSI, xxmaxRSI, slmin, intercmin
    # global slmax, intercmax, slminRSI, intercminRSI, slmaxRSI, intercmaxRSI
...
def divSignal2(df, x, nbackcandles):
    # global closp, xxclos, slclos, interclos
    backcandles = nbackcandles
    candleid = int(x.name)
